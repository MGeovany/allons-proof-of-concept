  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      <div className="relative h-52 w-full shrink-0 sm:h-64">
        ...
        />
        {/* Gradiente suave hacia el contenido oscuro */}
        <div
      ...
      <div className="-mt-6 flex flex-1 flex-col rounded-t-2xl bg-background px-0 pt-5 pb-4">
        {/* Tabs */}
        <div className="mb-5 overflow-hidden rounded-2xl bg-secondary/60">
        ...
        {tab === "evento" ? (
          <div className="px-4">
            ...
            <div className="flex gap-3 overflow-x-auto pb-24 scrollbar-none">
      ...
      {/* Botones fijos abajo (sin menu bar) */}
      <div className="fixed bottom-0 left-0 right-0 z-20 flex gap-3 border-t border-border bg-background px-4 py-4">
        <Link
