        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-full">
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-xl border border-border bg-background px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-orange-primary focus:outline-none focus:ring-1 focus:ring-orange-primary"
            />
          </div>
        </div>
